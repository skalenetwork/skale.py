...
class Constants(BaseContract):
    def set_periods(self, new_reward_period, new_delta_period, wallet):
        ...
        tx = sign_and_send(self.skale.web3, op, GAS['set_periods'], wallet)
        return {'tx': tx}
    ...
    def set_check_time(self, new_check_time, wallet):
        ...
        tx = sign_and_send(self.skale.web3, op, GAS['set_check_time'], wallet)
        return {'tx': tx}
    ...
    def set_latency(self, new_allowable_latency, wallet):
        ...
        tx = sign_and_send(self.skale.web3, op, GAS['set_latency'], wallet)
        return {'tx': tx}
