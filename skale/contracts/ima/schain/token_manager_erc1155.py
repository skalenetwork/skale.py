...
class TokenManagerERC1155(BaseContract):
    ...
    def add_erc1155_token(
        self, schain_name: str, token_mn: int, token_sc: int
    ) -> TxRes:
        return self.contract.functions.addERC1155TokenByOwner(
            schain_name, token_mn, token_sc
        )

    @transaction_method
    def exit_to_main_erc1155(
        self, token_address: int, token_id: int, amount: int
    ) -> TxRes:
        return self.contract.functions.exitToMainERC1155(
    ...
    def exit_to_main_erc1155_batch(
        ...
        return self.contract.functions.exitToMainERC1155Batch(
            token_addres, token_ids, amount
        )
