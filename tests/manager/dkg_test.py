...
def test_broadcast(skale):
    ...
    expected_txn = {
        ...
        'to': contract_address,
        'data': (
   ''  # noqa
        )
    }
    ...
    secret_key_contribution = [KeyShare(skale.wallet.public_key, share).tuple]
...
def test_response(skale):
    ...
    expected_txn = {
        ...
        'to': contract_address,
        'data': (
            ''  # noqa
        )
    }
    from_node_index = 0
    group_index = skale.schains.name_to_id(SCHAIN_NAME)
