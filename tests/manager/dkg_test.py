...
def test_response(skale):
    ...
    expected_txn = {
        'value': 0, 'gasPrice': skale.gas_price * 5 // 4, 'chainId': chain_id,
        'gas': 11000000, 'nonce': nonce,
        'to': contract_address,
        'data': (
            ''  # noqa
        )
    }
